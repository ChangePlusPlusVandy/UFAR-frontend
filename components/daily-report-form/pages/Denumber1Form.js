      ...
      <ScrollView style={styles.inputContainer} persistentScrollbar={true}>
        <View>
          ...
          <TextInput
            ...
            onChange={(e) =>
              props.setMenLessThanSixMonths(parseInt(e.nativeEvent.text) || 0)
            }
          />
          ...
          <TextInput
            ...
            onChange={(e) =>
              props.setMenSixMonthsToFiveYears(
          ...
          <TextInput
            ...
            onChange={(e) =>
              props.setMenFiveToFourteenYears(parseInt(e.nativeEvent.text) || 0)
            }
          />

          <Text style={styles.inputLabel}>
            # de Personnes de 15 ans et plus
          </Text>
          <TextInput
            editable={!props.validate}
            style={styles.inputField}
            ...
            onChange={(e) =>
              props.setMenFifteenAndOlder(parseInt(e.nativeEvent.text) || 0)
            }
          />
          <View style={{ alignItems: "center" }}>
            ...
            <TextInput
              ...
              value={props.totalNumMen.toString()}
            />
          </View>
        </View>
        <View style={{ marginTop: 20 }}>
          ...
          <TextInput
            ...
            onChange={(e) =>
              props.setWomenLessThanSixMonths(parseInt(e.nativeEvent.text) || 0)
            }
          />
          ...
          <TextInput
            ...
            onChange={(e) =>
              props.setWomenSixMonthsToFiveYears(
                parseInt(e.nativeEvent.text) || 0
              )
            }
          />
          ...
          <TextInput
            ...
            onChange={(e) =>
              props.setWomenFiveToFourteenYears(
                parseInt(e.nativeEvent.text) || 0
              )
            }
          />
          ...
          <TextInput
            ...
            onChange={(e) =>
              props.setWomenFifteenAndOlder(parseInt(e.nativeEvent.text) || 0)
            }
          />
          <View style={{ alignItems: "center" }}>
            ...
            <TextInput
              editable={!props.validate}
              style={styles.inputField}
              value={props.totalNumWomen.toString()}
            />
          </View>
        </View>
      </ScrollView>
