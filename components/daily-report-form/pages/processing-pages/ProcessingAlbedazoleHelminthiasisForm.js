          ...
          <View>
            ...
            <View style={styles.inputFieldContainer}>
              ...
              <TextInput
                ...
                defaultValue={(
                  props.numMenAlbendazoleHelminthiasis || "0"
                ).toString()}
              />
            </View>
          </View>
          ...
          <View>
            ...
            <View style={styles.inputFieldContainer}>
              ...
              <TextInput
                ...
                defaultValue={(
                  props.numWomenAlbendazoleHelminthiasis || "0"
                ).toString()}
              />
            </View>
          </View>
      ...
      <View style={styles.rowContainer}>
        <View style={styles.inputFieldContainer}>
          ...
          <TextInput
            editable={!props.validate}
            style={styles.inputField}
            value={props.totalNumAlbendazoleHelminthiasis.toString()}
          />
        </View>
        <View style={styles.inputFieldContainer}>
          <Text style={{ ...styles.inputLabelBigger, marginBottom: 0 }}>
          ...
          <TextInput
            ...
            style={styles.inputField}
            value={`${
              isFinite(props.totalCoverageAlbendazoleHelminthiasis)
                ? props.totalCoverageAlbendazoleHelminthiasis.toString()
                : "0"
            }%`}
          />
        </View>
