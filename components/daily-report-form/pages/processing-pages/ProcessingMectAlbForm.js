        ...
        <View>
            ...
            <View style={styles.rowContainer}>
                ...
                <View style={styles.inputFieldContainer}>
                    ...
                    <TextInput style={styles.inputField} value={props.totalNumMenMectAlb.toString()} />
                </View>
            </View>
            ...
            <View style={styles.rowContainer}>
                ...
                <View style={styles.inputFieldContainer}>
                    <Text style={styles.inputLabel}>Total</Text>
                    <TextInput style={styles.inputField} value={props.totalNumWomenMectAlb.toString()} />
                </View>
            </View>
            ...
            <View style={styles.rowContainer}>
                <View style={styles.inputFieldContainer}>
                    ...
                    <TextInput style={styles.inputField} value={props.totalNumMectAlb.toString()} />
                </View>
                <View style={styles.inputFieldContainer}>
                    <Text style={{...styles.inputLabelBigger, marginBottom: 0}}>Total couvert</Text>
                    <TextInput style={styles.inputField} value={`${isFinite(props.totalCoverageMectAlb) ? props.totalCoverageMectAlb.toString() : "0"}%`} />
                </View>
            </View>
        </View>
    );
