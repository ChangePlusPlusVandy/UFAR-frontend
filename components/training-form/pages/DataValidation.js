    ...
    return (
        <View>
            ...
            <View style={styles.inputContainer}>
                <Text style={styles.inputLabel}>Niveau ZS</Text>
                <Text style={styles.inputLabel}>Date du début de la validation des données au niveau AS</Text>
                <TextInput style={styles.inputField} onChange={(e) => props.setValidationASStartDateZS(e.nativeEvent.text)} defaultValue={props.validationASStartDateZS} placeholder="DD/MM/YYYY" />
